    ...
    for alpha in alphas:
        for itera in iters:
            for reg_lambda in reg_lambdas:
                ...
                log.info("Total accuracy for hidden_size: "+str(hidden_size)+", alpha: "+str(alpha)+", itera: "+str(itera)+", reg_lambda: "+str(reg_lambda)+" -> "+str(total_acc/nb_folds)+" ("+str(total_goals/nb_folds)+" goals/"+str(total_expg/nb_folds)+" expg | "+str(total_goal_expg/nb_folds)+" expg/goals)")
"""
