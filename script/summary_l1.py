...
def main():
    ...
    sot = read_csv("../data/stats/2015/all_games_sot.tsv", sep="\t") # sot/sot_teams.sql
    pdo = read_csv("../data/stats/2015/all_games_pdo.tsv", sep="\t") # pdo/pdo_teams.sql
    tsr = read_csv("../data/stats/2015/all_games_tsr.tsv", sep="\t") # total_shot_ratio/query_teams_tsr.sql
    ...
    teams_shots = DataFrame.from_csv('../data/stats/2015/all_games_shots_players.tsv', sep='\t', index_col=False) # expg/expg_by_player.sql
